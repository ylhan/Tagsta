...
public class TagManager {
  ...
  /**
   * Sets the various configuration settings the TagManager has using details gained from
   * FileManager
   */
   ...
   *
   * @return The configuration settings in a map with keys as settings and values as the settings'
   *     values
   */
   ...
   *
   * @param showExtensions Whether the extensions should be in the name of the ImageManager when one
   *     is displayed
   */
